...
public class FarmerController {
    ...
    public String index(Model model, HttpServletRequest request, User user){
        ...
        com.montealegreluis.yelpv3.client.Credentials clientId = new com.montealegreluis.yelpv3.client.Credentials("UsVIhi8B5OqaSawl-d_MIg","GJM3ct05cXXX0WjMcRN1LLxz5kOJAHs0pTD6Eu0Yu3yChpUFijugH_OF7WFzbxeF09TKcbYvRuYDNU9PCmoBcF2ohwG-c9sqTgZ0_jGGCJP4KENg6Tl8TbtnPQiuW3Yx");
/*
...
*/
        ...
        yelp.search(com.montealegreluis.yelpv3.search.SearchCriteria.byLocation("San Antonio"));
        yelp.search(com.montealegreluis.yelpv3.search.SearchCriteria.byCoordinates(29.426786, -98.489576));
        ...
        com.montealegreluis.yelpv3.businesses.SearchResult result = yelp.search(criteria).searchResult();
        model.addAttribute("businesses", result.total );
